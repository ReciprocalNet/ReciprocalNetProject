...
###############################################################################
Name: @dist.site.name@
Version: @dist.site.release@
Release: @dist.site.buildnumber@
Source: @dist.source-snapshot-file-truncated@
Buildroot: /tmp/@dist.site.name@-@dist.site.release@-@dist.site.buildnumber@
...
###############################################################################
%prep
%setup -c @dist.site.name@-@dist.site.release@
...
%build
ant site-server \
    -Ddist.site.name=@dist.site.name@ \
    -Ddist.site.release=@dist.site.release@ \
    -Ddist.site.buildnumber=@dist.site.buildnumber@ \
    -Ddist.site.signature-alias=@dist.site.signature-alias@ \
    -Ddist.site.signature-keystore=@dist.site.signature-keystore@ \
    -Ddist.site.signature-storepass=@dist.site.signature-storepass@
